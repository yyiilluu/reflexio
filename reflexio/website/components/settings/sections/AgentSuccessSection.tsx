...
import type { Config, AgentSuccessConfig } from "@/app/settings/types"
    ...
    <>
      <Card className="border-slate-200 bg-white overflow-hidden hover:shadow-lg transition-all duration-300">
        ...
        <CardContent>
                  ...
                  <AccordionContent className="pt-2 pb-5 space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => onUpdate(success.id, { evaluation_name: e.target.value })}
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => onUpdate(success.id, { success_definition_prompt: e.target.value })}
                      ...
                      <div className="grid grid-cols-3 gap-3 items-center">
                        <div className="col-span-2">
                          <input
                            ...
                            onChange={(e) => onUpdate(success.id, { sampling_rate: parseFloat(e.target.value) / 100 })}
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              if (!isNaN(value) && value >= 0 && value <= 100) {
                                onUpdate(success.id, { sampling_rate: value / 100 })
                              }
                            }}
                      ...
                      <CollapsibleContent className="space-y-4 pt-4">
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => onUpdate(success.id, { metadata_definition_prompt: e.target.value })}
                        ...
                        <WindowOverrideFields
                          ...
                          onWindowSizeChange={(v) => onUpdate(success.id, { extraction_window_size_override: v })}
                          onWindowStrideChange={(v) => onUpdate(success.id, { extraction_window_stride_override: v })}
                        />
                      </CollapsibleContent>
                    </Collapsible>
                  </AccordionContent>
          ...
          <Button onClick={onAdd} variant="outline" className={`w-full h-9 text-sm ${successes.length > 0 ? "mt-4" : ""}`}>
