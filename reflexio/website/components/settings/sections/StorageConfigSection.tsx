...
export function StorageConfigSection({ config, onStorageUpdate, onStorageTypeChange }: StorageConfigSectionProps) {
  return (
      ...
      <CardContent className="space-y-4">
        ...
        {config.storage_config.type === "local" && (
          <div>
            ...
            />
            <p className="text-xs text-muted-foreground mt-1">Local directory path for storing data</p>
          </div>
        )}
        ...
        {config.storage_config.type === "supabase" && (
          <div className="space-y-3">
            <div>
              <FieldLabel htmlFor="supabase-url" required>Supabase URL</FieldLabel>
              <Input
                id="supabase-url"
            ...
            <div>
              <FieldLabel htmlFor="supabase-key" required>Supabase Key</FieldLabel>
              <PasswordInput
            ...
            <div>
              <FieldLabel htmlFor="db-url" required>Database URL</FieldLabel>
              <Input
                id="db-url"
