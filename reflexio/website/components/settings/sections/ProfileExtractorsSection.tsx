    ...
    <>
      <Card className="border-slate-200 bg-white overflow-hidden hover:shadow-lg transition-all duration-300">
        ...
        <CardContent>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 shrink-0" onClick={(e) => e.stopPropagation()}>
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => onUpdate(extractor.id, { manual_trigger: !checked })}
                  ...
                  <AccordionContent className="pt-2 pb-5 space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => onUpdate(extractor.id, { extractor_name: e.target.value })}
                    ...
                    <div>
                      <FieldLabel htmlFor={`ext-def-${extractor.id}`}>Profile Content Definition</FieldLabel>
                      <textarea
                        id={`ext-def-${extractor.id}`}
                        value={extractor.profile_content_definition_prompt}
                        onChange={(e) => onUpdate(extractor.id, { profile_content_definition_prompt: e.target.value })}
                    ...
                    <Collapsible>
                      ...
                      <CollapsibleContent className="space-y-4 pt-4">
                        <div className="grid gap-4 sm:grid-cols-2">
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) => onUpdate(extractor.id, { context_prompt: e.target.value })}
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) => onUpdate(extractor.id, { metadata_definition_prompt: e.target.value })}
                              className="flex min-h-[120px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring resize-y"
                        ...
                        <WindowOverrideFields
                          ...
                          onWindowSizeChange={(v) => onUpdate(extractor.id, { extraction_window_size_override: v })}
                          onWindowStrideChange={(v) => onUpdate(extractor.id, { extraction_window_stride_override: v })}
                        />
                      </CollapsibleContent>
                    </Collapsible>
                  </AccordionContent>
          ...
          <Button onClick={onAdd} variant="outline" className={`w-full h-9 text-sm ${extractors.length > 0 ? "mt-4" : ""}`}>
