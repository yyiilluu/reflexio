            ...
            <div className="bg-white/90 px-4 py-3 rounded-lg shadow-md w-full">
              <div className="mb-3 space-y-1">
                <p className="text-xs text-gray-600">
                  <strong className="text-[#fb8500]">Window Size ({windowSize}):</strong> Number of interactions processed in each batch
                </p>
                <p className="text-xs text-gray-600">
                  <strong className="text-[#fb8500]">Stride ({windowStride}):</strong> Distance between start of consecutive windows
                </p>
              </div>
              <svg width="100%" height="110" viewBox="0 0 280 110" className="overflow-visible">
                {(() => {
                  ...
                  const timelineEnd = Math.max(window2End + 20, timelineStart + maxTimelineWidth * 0.7)
                  ...
                  return (
                    <>
                      ...
                      {[...Array(Math.floor((timelineEnd - timelineStart) / 12) + 1)].map((_, i) => (
                        <circle
                          key={`dot-${i}`}
